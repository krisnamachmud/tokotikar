...
<head>
    <meta charset="utf-8">
    <title>TOKO TIKAR LAMONGAN</title>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index.html" class="navbar-brand">
                    <h1 class="text-primary display-6">Tikar Lipat</h1>
                </a>
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">Tikar Lipat</h1>
                            <p class="text-secondary mb-0">Serbaguna</p>
                        </a>
                    </div>
                    <div class="col-lg-9">
